...
public class Ladino extends RpgCharacter {
    
    public Ladino(int vida, int forca, int velocidade, int resistencia, int destreza, int inteligencia) {
    ...
    public Map<Integer, Integer> calcAtaque(RpgCharacter alvo) {
        ...
        Integer danoLimpo = (super.getVelocidade() + super.getDestreza()) / 10;
